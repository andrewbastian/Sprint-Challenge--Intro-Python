...
c = [human.name for human in humans if any([human.name.startswith('C'),
                                            human.name.startswith('D'),
                                            human.name.startswith('E'),
                                            human.name.startswith('F'),
                                            human.name.startswith('G')])]
print(c)
